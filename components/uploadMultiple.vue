<template>
  <div style="outline: none;">
    <div class="image-container position-relative text-center" v-if="!images.length" :style=styleContainer>
      ...
      <div v-else class="image-center position-absolute display-flex flex-column justify-content-center align-items-center" @dragover.prevent="onDragover">
        ...
        <div class="text-center">
          <p>{{dragText}}</p>
          <v-btn small class="browse-text" secondaryAlt>{{browseText}}</v-btn>
        </div>
    ...
    <div class="image-container position-relative text-center image-list" v-else>
      ...
      <div v-else style="align-text: center">
        <i class="fas fa-file-archive" style="font-size: 48px; margin: 20px 0 10px 0"></i>
        <div >Berhasil diunggah</div>
      </div>
    ...
    <div v-if="images.length && multiple">
      <div v-if="isImageUpload" class="image-list-container display-flex flex-wrap" >
    ...
    <vue-image-lightbox-carousel v-if="isImageUpload"
      ref="lightbox"
      :show="showLightbox"
...
export default {
  ...
  props: {
    ...
    dragText: {
      type: String,
      default: 'Drop your files here or',
    },
    browseText: {
      type: String,
      default: 'Browse',
        ...
        reader.onload = (e) => {
          ...
          if (dataURI) {
            if (!this.images.length) {
              this.images.push({
                name: file.name, path: dataURI, highlight: 1, default: 1, deleteUrl: '', imageId: '', uploadUrl: '',
              });
